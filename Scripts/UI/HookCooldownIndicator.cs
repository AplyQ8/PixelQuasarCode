...
namespace UI
{
    public class HookCooldownIndicator : MonoBehaviour
    {
        public static HookCooldownIndicator Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            _heroStateHandler.HookingState.OnCooldownClickEvent += ToggleOn;
        ...
        {
            _heroStateHandler.HookingState.HookCooldownTimer
        ...
        private void OnTimerChangeEvent(float time)
        {
            ...
            cooldownMask.fillAmount = time / _heroStateHandler.HookingState.HookCooldown;
        }
