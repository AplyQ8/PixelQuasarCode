...
namespace UI
{
    public class SuperAttackCooldownIndicator : MonoBehaviour
    {
        public static SuperAttackCooldownIndicator Instance { get; private set; }
        ...
        private void Start()
        {
            ...
            _heroStateHandler.SuperAttackState.OnCooldownClickEvent += ToggleOn;
        ...
        {
            _heroStateHandler.SuperAttackState.CooldownTimer
        ...
        private void OnTimerChangeEvent(float time)
        {
            ...
            cooldownMask.fillAmount = time / _heroStateHandler.SuperAttackState.CurrentSuperAttack.Cooldown;
        }
